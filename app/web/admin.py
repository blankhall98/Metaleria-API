...
async def comisionario_record(
    ...
    return templates.TemplateResponse(
        "admin/comisionario_record.html",
        {
            ...
            "origen_map": comision_service.origen_por_comision(db, notas_filtradas),
...
async def comisionario_notas_list(
    ...
    return templates.TemplateResponse(
        "admin/comisionario_notas_list.html",
        {
            ...
            "user": current_user,
            "notas": notas,
            "origen_map": comision_service.origen_por_comision(db, notas),
            "comisionarios": comisionarios,
    ...
    *,
    ...
    return templates.TemplateResponse(
        "admin/comisionario_nota_detail.html",
        {
            ...
            "pagado": pagado,
            "saldo": saldo,
            # Solicitud 04-sep-2026: de qué nota y de qué socio viene la comisión.
