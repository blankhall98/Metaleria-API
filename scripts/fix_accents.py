...
PHRASES: list[tuple[str, str]] = [
    ...
    ("log contable", "movimiento contable"),
    ("Stock actual", "Existencias actuales"),
    ("Stock estimado", "Existencias estimadas"),
    ("Stock anterior", "Existencias anteriores"),
    ("Stock resultante", "Existencias resultantes"),
